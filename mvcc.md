...
only the [newest version](/docs/cloudant-gen2?topic=cloudant-gen2-documents) of a document.
{: shortdesc}

Because {{site.data.keyword.cloudant_short_notm}} databases are [eventually consistent](/docs/cloudant-gen2?topic=cloudant-gen2-cap-theorem),
...
You must specify the previous `_rev` when you [update a document](/docs/cloudant-gen2?topic=cloudant-gen2-documents#update)
or else your request fails and returns a [409 error](/docs/apis/cloudant/cloudant-gen2#error-handling){: external}.
...
a solution is to [create a new document](/docs/cloudant-gen2?topic=cloudant-gen2-create-document) for each revision.
...
To find conflicts,
add the query parameter [`conflicts=true`](/docs/cloudant-gen2?topic=cloudant-gen2-get-changes) when you retrieve a document.
...
```https
https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID?conflicts=true
```
{: codeblock}
...
```https
https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID
https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID?rev=2-61ae00e029d4f5edd2981841243ded13
https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID?rev=1-7438df87b632b312c53a08361a7c3299
```
{: codeblock}
...
```http
DELETE https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID?rev=2-61ae00e029d4f5edd2981841243ded13
```
{: codeblock}
