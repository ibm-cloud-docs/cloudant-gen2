...
For security purposes, the {{site.data.keyword.cloudant_short_notm}} team recommends that you use IAM API keys rather than account-level credentials for replication jobs. For more information, see [Managing access](/docs/cloudant-gen2?topic=cloudant-gen2-managing-access-for-cloudant).
{: important}
...
the [`_changes` endpoint](/docs/cloudant-gen2?topic=cloudant-gen2-get-changes).
However,
...
The [CAP Theorem](/docs/cloudant-gen2?topic=cloudant-gen2-cap-theorem#cap-theorem) discussion makes it clear that
...
[`"use_checkpoints": false`](/docs/apis/cloudant/cloudant-gen2#postreplicate){: external} option when you request replication.
...
In general,
[create API keys](/docs/cloudant-gen2?topic=cloudant-gen2-connecting) that have:
...
They can also be created [programmatically](/docs/apis/cloudant/cloudant-gen2#intro) by using the {{site.data.keyword.cloudant_short_notm}} API.
...
or by setting the [`continuous`](/docs/apis/cloudant/cloudant-gen2#postreplicate){: external} flag in the {{site.data.keyword.cloudant_short_notm}} API.
...
[Filter functions](/docs/cloudant-gen2?topic=cloudant-gen2-design-documents#filter-functions) are stored
in [design documents](/docs/cloudant-gen2?topic=cloudant-gen2-design-documents#design-documents).
...
the [`_changes` endpoint](/docs/apis/cloudant/cloudant-gen2#postchanges-databases).
...
For more information, see [Using the {{site.data.keyword.cloudant_short_notm}} changes feed FAQ](/docs/cloudant-gen2?topic=cloudant-gen2-faq-using-changes-feed&code=javascript).
...
pass a [`since` argument](/docs/cloudant-gen2?topic=cloudant-gen2-get-changes#the-since-argument) with the sequence number you want to start from.
...
For example,
see the SDK examples in the [{{site.data.keyword.cloudant_short_notm}} API docs](/docs/apis/cloudant/cloudant-gen2#postchanges-databases)
...
API keys are generated in the {{site.data.keyword.cloudant_short_notm}} Dashboard or through the [API](/docs/apis/cloudant/cloudant-gen2){: external}.
...
[Advanced replication API options](/docs/cloudant-gen2?topic=cloudant-gen2-advanced-replication#advanced-replication) are available. These options enable an increase or decrease in the amount of computing power that is used during replication, as shown in the following examples:
...
- If you have many tiny documents, then you might consider increasing the [`worker_process`](/docs/cloudant-gen2?topic=cloudant-gen2-advanced-replication#performance-related-options) and [`http_connections`](/docs/cloudant-gen2?topic=cloudant-gen2-advanced-replication#performance-related-options) values.
...
- For more information, see [{{site.data.keyword.cloudant_short_notm}} replication](/docs/cloudant-gen2?topic=cloudant-gen2-replication-api).
