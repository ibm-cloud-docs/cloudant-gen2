...
`https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/$DATABASE/_all_docs/queries`.
...
`https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/$DATABASE/_design/$DDOC/_view/$VIEW/queries`.
