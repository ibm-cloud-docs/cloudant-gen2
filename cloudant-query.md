...
Start learning about queries by reading [Selector syntax](/docs/cloudant-gen2?topic=cloudant-gen2-selector-syntax).
...
- [Working with JSON indexes](/docs/cloudant-gen2?topic=cloudant-gen2-json-indexes).
- [Working with text indexes](/docs/cloudant-gen2?topic=cloudant-gen2-text-indexes).
- [Partial indexes](/docs/cloudant-gen2?topic=cloudant-gen2-partial-indexes).
...
Use [bookmark pagination](/docs/apis/cloudant/cloudant-gen2#bookmark-pagination) for selector syntax queries.
For specific details and examples see the API documentation topic [Paging on selector syntax queries](/docs/apis/cloudant/cloudant-gen2#paging-on-selector-syntax-queries).
