...
{{site.data.keyword.cloudant_short_notm}} Standard plan. Next,
...
## Calculating data usage for the Standard plans
{: #data-usage}

The data storage that is measured for billable purposes for a {{site.data.keyword.cloudant_short_notm}} instance includes JSON data, secondary indexes, and attachments. While Cloudant stores data in triplicate for high availability, you are only charged as if there is a single copy of your data.

| **Data storage** | **Standard Plan**                                      |
|----------------------------------|-------------------------------------------------------|
| **Included in plan**                | 20 GB |
| **Extra storage**                | Charged per GB                   |
| **Write limit on overuse** | No                                         |
...
## Provisioned throughput capacity units for the Standard plan
...
The current number of read, write and global query operations per provisioned throughput capacity unit is described in [Scaling provisioned throughput capacity](/docs/cloudant-gen2?topic=cloudant-gen2-usage-and-charges#scaling-provisioned-throughput-capacity)
...
[galldocs]: /docs/apis/cloudant/cloudant-gen2#postalldocs
[gmrview]: /docs/apis/cloudant/cloudant-gen2#postview
[gsearchindex]: /docs/apis/cloudant/cloudant-gen2#postsearch
[gqueryfind]: /docs/apis/cloudant/cloudant-gen2#postfind
[palldocs]: /docs/apis/cloudant/cloudant-gen2#postpartitionalldocs
[pmrview]: /docs/apis/cloudant/cloudant-gen2#postpartitionview
[psearchindex]: /docs/apis/cloudant/cloudant-gen2#postpartitionsearch
[pqueryfind]: /docs/apis/cloudant/cloudant-gen2#postpartitionfind-partitioned-databases
[bulkdocs]: /docs/apis/cloudant/cloudant-gen2#postbulkdocs
[bulkget]: /docs/apis/cloudant/cloudant-gen2#postbulkget
...
[response header](/docs/apis/cloudant/cloudant-gen2#response-headers) to see the class
of the request.
{: tip}
...
When a request is rejected, your application receives a HTTP [`429` Too Many Requests](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} response with a description of the error.
...
{{site.data.keyword.cloudant_short_notm}} provides metrics for your instance's number of `429` responses in [IBM Cloud Monitoring](/docs/cloudant-gen2?topic=cloudant-gen2-monitor-ibm-cloud-pm). {{site.data.keyword.cloudant_short_notm}} recommend setting up alerts to ensure you are notified when your application receives sustained `429` responses.
{: tip}

### 429 support in client libraries
{: #429-support-in-client-libraries}

{{site.data.keyword.cloudant_short_notm}}'s [supported client libraries](/docs/cloudant-gen2?topic=cloudant-gen2-client-libraries) help you handle a `429` response. See each library's documentation for their behavior when receiving `429` responses.
...
You can reduce the approximate read and write consumption of a replication job by adjusting the [performance-related options](/docs/cloudant-gen2?topic=cloudant-gen2-advanced-replication#performance-related-options) that are associated with [tuning replication speed](/docs/cloudant-gen2?topic=cloudant-gen2-replication-guide#tuning-replication-speed). The following table provides recommended options for users who want to reduce the read capacity used on the source database:
