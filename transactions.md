...
such as an `order_id`,
call the [`GET _uuids` endpoint](/docs/apis/cloudant/cloudant-gen2#getuuids){: external} on the {{site.data.keyword.cloudant_short_notm}} API.
...
Use the built-in [`_sum` reducer](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce#built-in-reduce-functions)
