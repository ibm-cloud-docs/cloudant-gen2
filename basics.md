...
- [Client Libraries](/docs/cloudant-gen2?topic=cloudant-gen2-client-libraries#client-libraries)
- [API and SDK reference](/docs/apis/cloudant/cloudant-gen2#intro){: external}
...
For more information about how {{site.data.keyword.cloudant_short_notm}} uses HTTP, see [HTTP](/docs/cloudant-gen2?topic=cloudant-gen2-how-http-works-with-cloudant) in the API reference.
...
a [405](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} error is returned. The error that lists the supported HTTP methods, as shown in the following example.
...
More information about JSON can be found in the [JSON Guide](/docs/cloudant-gen2?topic=cloudant-gen2-how-json-works).
...
see the [CAP Theorem](/docs/cloudant-gen2?topic=cloudant-gen2-cap-theorem) guide.

## Replication
{: #replication-basics}

[Replication](/docs/cloudant-gen2?topic=cloudant-gen2-replication-api) is a procedure followed by {{site.data.keyword.cloudant_short_notm}},
