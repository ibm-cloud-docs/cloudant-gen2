...
If you're changing the same piece of data at a rate of once per second or more, consider
...
Behind the `https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/` interface is a distributed database.
...
[emitting each tag as a key in your view's map function](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce).
