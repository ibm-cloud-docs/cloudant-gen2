...
[explain plan](/docs/cloudant-gen2?topic=cloudant-gen2-explain-plans) for each query.
...
see the [Search documentation](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-search).
