...
the server sends a [`304 Not Modified`](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} status code,
and the response itself has no body.

If the document was modified,
you get a normal [`200` response](/docs/apis/cloudant/cloudant-gen2#error-handling){: external},
...
to get a [`304 Not Modified`](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} response if the revision is still current.
