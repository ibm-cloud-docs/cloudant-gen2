...
Although data is stored redundantly within an {{site.data.keyword.cloudant_short_notm}} cluster, it's important to consider extra backup measures. {{site.data.keyword.cloudant_short_notm}} provides a supported tool for snapshot backup and restore. The tool is called *CouchBackup*, and is open source. For more information, see [Introducing CouchBackup](/docs/cloudant-gen2?topic=cloudant-gen2-ibm-cloudant-backup-and-recovery#introducing-couchbackup).

To implement resilience to full region outages, you can create replication to another {{site.data.keyword.cloudant_short_notm}} instance in a different region with bidirectional continuous replication. This supports either active-passive or active-active configuration. For more information, see [replication setup for cross-region disaster recovery](/docs/cloudant-gen2?topic=cloudant-gen2-configuring-ibm-cloudant-for-cross-region-disaster-recovery).
...
| Feature | Description | Consideration |
| -------------- | -------------- | -------------- |
| Backup and restore | Restore a database from previously created backup; see {{site.data.keyword.cloudant_short_notm}} [backup and recovery](/docs/cloudant-gen2?topic=cloudant-gen2-ibm-cloudant-backup-and-recovery). | Open source tool. Customer configured. |
| Cross-region failover | {{site.data.keyword.cloudant_short_notm}} [replication](/docs/cloudant-gen2?topic=cloudant-gen2-configuring-ibm-cloudant-for-cross-region-disaster-recovery) helps you build a complete disaster recovery capability. |  Customer configured.  |
...
For more information about responsibility ownership between you and {{site.data.keyword.cloud_notm}} for {{site.data.keyword.cloudant_short_notm}}, see [Understanding your responsibilities when you use {{site.data.keyword.cloudant_short_notm}}](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-responsibilities).
...
Updates affecting customer workloads are communicated through IBM Cloud notification. Changes that impact customer workloads are detailed in {{site.data.keyword.cloud_notm}} notifications. For more information about planned maintenance, announcements, and release notes that impact this service, see [Monitoring notifications and status](/docs/support?topic=support-best-practices).

## How {{site.data.keyword.IBM_notm}} maintains services
{: #ibm-service-maintenance}

Stay updated with [Service changes and deprecations](/docs/cloudant-gen2?topic=cloudant-gen2-deprecations-for-ibm-cloudant) and [Release notes](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-gen2-relnotes) of {{site.data.keyword.cloudant_short_notm}}.
