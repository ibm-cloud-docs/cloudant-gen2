...
For more information, see [Automatic cleanup of deleted documents (tombstones)](/docs/cloudant-gen2?topic=cloudant-gen2-faq-enabling-automatic-removal-of-document-tombstones).
