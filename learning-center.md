...
That's the end of this course. For more information, see the [{{site.data.keyword.cloudant_short_notm}} documentation](/docs/cloudant-gen2?topic=cloudant-gen2-getting-started-with-cloudant) and [blog](https://blog.cloudant.com/).
