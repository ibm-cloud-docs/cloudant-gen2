...
page](/docs/cloudant-gen2?topic=cloudant-gen2-how-is-data-stored-in-ibm-cloudant-),
...
Refer to [{{site.data.keyword.cloudant_short_notm}} Limits](/docs/cloudant-gen2?topic=cloudant-gen2-limits) for details on these restrictions.
...
See [How sharding affects database performance](/docs/cloudant-gen2?topic=cloudant-gen2-how-is-data-stored-in-ibm-cloudant-#how-does-sharding-affect-performance-) for details of how global and partition-scoped queries affect performance of your database operations.
...
- [Views](/docs/apis/cloudant/cloudant-gen2#postview)
- [{{site.data.keyword.cloudant_short_notm}} Query](/docs/apis/cloudant/cloudant-gen2#postfind)
- [Search](/docs/apis/cloudant/cloudant-gen2#postsearch)
...
- [Views](/docs/apis/cloudant/cloudant-gen2#postpartitionview)
- [{{site.data.keyword.cloudant_short_notm}} Query](/docs/apis/cloudant/cloudant-gen2#postpartitionfind-partitioned-databases)
- [Search](/docs/apis/cloudant/cloudant-gen2#postpartitionsearch)
...
1. Read [Creating an IoT historian using partitioned databases](/docs/cloudant-gen2?topic=cloudant-gen2-creating-an-iot-historian-using-partitioned-databases) for a deep dive into partitioned databases with examples in several programming languages.
