...
It warns you by returning a [`409` response](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} to a problematic update request.
However,
...
write a [view](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce).
...
DELETE https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/products/$_ID?rev=2-f796915a291b37254f6df8f6f3389121
```
{: codeblock}
