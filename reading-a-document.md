...
2. Run the following command: `https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/$DATABASE/$DOCUMENT_ID`.
...
you can [query the database](/docs/apis/cloudant/cloudant-gen2#postalldocsqueries){: external} for all documents.
...
[query the database](/docs/apis/cloudant/cloudant-gen2#postalldocs){: external}
