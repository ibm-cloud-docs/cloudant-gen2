...
Later,
the index can be queried by using the `$text` operator. For more information, see the [Search documentation](/docs/cloudant-gen2?topic=cloudant-gen2-search-analyzers) for alternative analyzers.
