...
For more information, see [Data modeling](/docs/cloudant-gen2?topic=cloudant-gen2-data-modeling) or [{{site.data.keyword.cloudant_short_notm}} in practice](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-in-practice).
...
- {{site.data.keyword.cloudant_short_notm}} Query [docs](/docs/cloudant-gen2?topic=cloudant-gen2-query)
- {{site.data.keyword.cloudant_short_notm}} guide to using [views](/docs/cloudant-gen2?topic=cloudant-gen2-using-views#using-views)
- Performance implications of using [include_docs](/docs/cloudant-gen2?topic=cloudant-gen2-using-views#multi-document-fetching)
...
For more information, see [{{site.data.keyword.cloudant_short_notm}} Query docs](/docs/cloudant-gen2?topic=cloudant-gen2-query).
...
We also have the issue of which fields that you store in an {{site.data.keyword.cloudant_short_notm}} Search. Stored fields are retrieved in the query without doing `include_docs=true` so the tradeoff is similar to the [Understand the tradeoffs in emitting data or not into a view](/docs/cloudant-gen2?topic=cloudant-gen2-indexing-and-querying#tradeoffs-emit-data-or-not-in-view) section.
For more information, see {{site.data.keyword.cloudant_short_notm}} Search [docs](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-search).
...
- {{site.data.keyword.cloudant_short_notm}} guide to [design document management](/docs/cloudant-gen2?topic=cloudant-gen2-design-document-management#design-document-management).
...
- [Partitioned Databases documentation](/docs/cloudant-gen2?topic=cloudant-gen2-database-partitioning)
