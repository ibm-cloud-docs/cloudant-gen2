...
1.	Set up a [filtered replication](/docs/cloudant-gen2?topic=cloudant-gen2-advanced-replication#filtered-replication-adv-repl) to replicate documents from the original database to the new database.
...
See an example replication that excludes deleted documents during a replication:

```json
{
  "_id": "myfirstreplication",
  "source" : {
    "url": "https://00000000-0000-0000-0000-00000000.abc.cloudant.eu-de.dataservices.appdomain.cloud/source_db",
		"auth": {
			"iam": {
				"apikey":	"myapikey"
			}
  ...
  "target" : {
		"url": "https://00000000-0000-0000-0000-00000000.abc.cloudant.eu-de.dataservices.appdomain.cloud/target_db",
		"auth": {
			"iam": {
			  "apikey":	"myapikey"
			}
