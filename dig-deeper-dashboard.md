...
You need to create a service instance in {{site.data.keyword.cloudant_short_notm}} before you start this tutorial. You can follow the instructions in the [Getting started](/docs/cloudant-gen2?topic=cloudant-gen2-getting-started-with-cloudant) tutorial to create one.
...
- [{{site.data.keyword.cloudant_short_notm}} Query documentation](/docs/cloudant-gen2?topic=cloudant-gen2-query)
...
- {{site.data.keyword.cloudant_short_notm}} Search uses "analyzers" to pre-process text before indexing. Learn about [Search Analyzers](/docs/cloudant-gen2?topic=cloudant-gen2-search-analyzers) to ensure you get the results that you expect.
- [{{site.data.keyword.cloudant_short_notm}} Search documentation](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-search)
...
- [MapReduce documentation](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce)
