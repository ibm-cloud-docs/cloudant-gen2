...
see the topic on [Consistency](/docs/cloudant-gen2?topic=cloudant-gen2-cap-theorem#cap-theorem).
...
- A `_rev` field. The `_rev` field is a revision identifier, and is [essential to the {{site.data.keyword.cloudant_short_notm}} replication protocol](/docs/cloudant-gen2?topic=cloudant-gen2-document-versioning-and-mvcc#document-versioning-and-mvcc).
...
[Views]: /docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce
