...
see the [Managing tasks](/docs/cloudant-gen2?topic=cloudant-gen2-managing-tasks#managing-tasks) guide.
...
```sh
curl "https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/_active_tasks" \
	-u $ACCOUNT
```
{: codeblock}
{: curl}
