...
{{site.data.keyword.cloudant_short_notm}} has a raw [changes feed API](https://cloud.ibm.com/docs/apis/cloudant/cloudant-gen2#getchanges-changes){: external} that can be used to consume a single database's changes but it must be used with care.
...
- A querying mechanism. For more information, see [MapReduce Views](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce) for creating views of your data that is ordered by a key of your choice.
