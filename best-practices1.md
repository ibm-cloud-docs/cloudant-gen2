...
For more information, see [Indexing and querying](/docs/cloudant-gen2?topic=cloudant-gen2-indexing-and-querying) or [{{site.data.keyword.cloudant_short_notm}} in practice](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-in-practice).
...
- {{site.data.keyword.cloudant_short_notm}} [API docs](/docs/apis/cloudant/cloudant-gen2){: external}
- Logging [integration](/docs/cloudant-gen2?topic=cloudant-gen2-monitor-ibm-cloud-pm){: external}
...
- {{site.data.keyword.cloudant_short_notm}} guide to [data modeling](/docs/cloudant-gen2?topic=cloudant-gen2-five-tips-for-modeling-your-data-to-scale-faq)
- [Database partitions](/docs/cloudant-gen2?topic=cloudant-gen2-database-partitioning){: external}
...
- {{site.data.keyword.cloudant_short_notm}} docs on [attachments](/docs/cloudant-gen2?topic=cloudant-gen2-how-to-use-attachments)
...
For more information, see {{site.data.keyword.cloudant_short_notm}} docs on [reduces](/docs/cloudant-gen2?topic=cloudant-gen2-creating-views-mapreduce#reduce-functions){: external}.
