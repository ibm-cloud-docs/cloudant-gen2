...
|Description|Limit|
|--|--|
|Database count|200 (default) on Standard Plan. You can contact {{site.data.keyword.cloudant_short_notm}} support if you need more databases.|
...
If you exceed these limits, a [413 response](/docs/apis/cloudant/cloudant-gen2#error-handling){: external} alerts you.
...
errors](/docs/apis/cloudant/cloudant-gen2#getreplicationdocument){: external}.
