...
For more information, see [Using views](/docs/cloudant-gen2?topic=cloudant-gen2-using-views#using-views).
...
A design document can be [created or updated](/docs/cloudant-gen2?topic=cloudant-gen2-design-documents#creating-or-updating-a-design-document)
