...
subcollection: cloudant-gen2-gen2
...
# Release notes for {{site.data.keyword.cloudant_short_notm}} Gen2
{: #cloudant-gen2-relnotes}
...
: {{site.data.keyword.cloudant_short_notm}} is now available on Gen 2 of {{site.data.keyword.cloud_notm}} with the Standard Plan. Customers can select a Gen2 location and create a Cloudant instance. This platform offers various benefits over the Gen 1 platform, for example:
   ...
   - IAM authentication is available out of the box.

    Review the product documentation to find out about the latest changes. Take a look at [Overview of Gen 1 (Classic) and Gen 2 (VPC)](/docs/cloudant-gen2?topic=cloudant-gen2-overview-gen1-gen2) and [Getting started](/docs/cloudant-gen2?topic=cloudant-gen2-getting-started-with-cloudant).
