...
You can find information about auditing in [Audit logging](/docs/cloudant-gen2?topic=cloudant-gen2-audit-logging#audit-logging){: external}.
...
you must encrypt or otherwise protect (pseudonymize) your data before you send it to us. Do not use PI as a document `_id` in your URLs, for example, `https://$ACCOUNT.abc.cloudant.eu-de.dataservices.appdomain.cloud/$DATABASE/$DOCUMENT_ID`,
...
Physical security of our data centers is handled by the infrastructure provider: {{site.data.keyword.cloud}}. All hold externally audited certifications for their physical security. {{site.data.keyword.cloudant_short_notm}}
...
For more information, see [Simple removal of "tombstone" documents](/docs/cloudant-gen2?topic=cloudant-gen2-documents#tombstone-documents){: external}.
...
[{{site.data.keyword.cloudant_short_notm}} backup and recovery](/docs/cloudant-gen2?topic=cloudant-gen2-ibm-cloudant-backup-and-recovery#ibm-cloudant-backup-and-recovery){: external}.
