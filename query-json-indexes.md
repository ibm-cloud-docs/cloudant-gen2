...
| Field | Description |
|-------|-------------|
| `index` | fields - A JSON array of field names that uses the [sort syntax](/docs/cloudant-gen2?topic=cloudant-gen2-query#sort-syntax). Nested fields are also allowed, for example, `person.name`. |
