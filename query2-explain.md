...
Use the `use_index` and `allow_fallback` query parameters to control index use for queries. See [Query parameters](/docs/cloudant-gen2?topic=cloudant-gen2-ibm-cloudant-query-parameters) for full details.
