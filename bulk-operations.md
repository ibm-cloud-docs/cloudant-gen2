...
| `202` | For at least one document, the write [quorum](/docs/cloudant-gen2?topic=cloudant-gen2-documents#quorum-writing-and-reading-data) wasn't met.                                                                                                                                               |
...
The return code from a successful bulk insertion is [`201`](/docs/apis/cloudant/cloudant-gen2#error-handling){: external}.
...
If your request receives a [`202` response](/docs/apis/cloudant/cloudant-gen2#error-handling){: external},
...
Conflict resolution that uses the bulk docs interface is identical to the resolution procedures outlined in the [Conflicts](/docs/cloudant-gen2?topic=cloudant-gen2-conflicts
) documentation.
...
The `_bulk_get` endpoint is similar to the [`_all_docs`](/docs/apis/cloudant/cloudant-gen2#postalldocs){: external} endpoint,
