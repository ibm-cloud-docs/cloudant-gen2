...
{: #detect-inefficient-query}

[{{site.data.keyword.cloudant_short_notm}} query
requests](/docs/apis/cloudant/cloudant-gen2#postfind) can return information which allows you
...
Refer to [{{site.data.keyword.cloudant_short_notm}} Query performance optimization](/docs/cloudant-gen2?topic=cloudant-gen2-cloudant-query-performance-guide) for a complete guide to creating efficient and scalable indexes and queries.
