...
For more information, see [Data modeling](/docs/cloudant-gen2?topic=cloudant-gen2-data-modeling) or [Indexing and querying](/docs/cloudant-gen2?topic=cloudant-gen2-indexing-and-querying).
...
- {{site.data.keyword.cloudant_short_notm}} guide to [conflicts](/docs/cloudant-gen2?topic=cloudant-gen2-conflicts#conflicts)
...
- {{site.data.keyword.cloudant_short_notm}} [guide to replication](/docs/cloudant-gen2?topic=cloudant-gen2-replication-guide#replication)
...
- {{site.data.keyword.cloudant_short_notm}} [bulk operations docs](/docs/cloudant-gen2?topic=cloudant-gen2-bulk-operations)
...
- {{site.data.keyword.cloudant_short_notm}} documentation on [usage and charges](/docs/cloudant-gen2?topic=cloudant-gen2-usage-and-charges) on {{site.data.keyword.IBM_notm}} public cloud
