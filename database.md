...
These JSON objects are called [documents](/docs/cloudant-gen2?topic=cloudant-gen2-documents#documents).
{: shortdesc}
...
The [Grouping related documents together in {{site.data.keyword.cloudant_short_notm}}](/docs/cloudant-gen2?topic=cloudant-gen2-grouping-related-documents-together-in-ibm-cloudant#grouping-related-documents-together-in-ibm-cloudant) guide provides an example of how documents for an e-commerce application might be used within an {{site.data.keyword.cloudant_short_notm}} database.
...
For more information, see [Database partitioning](/docs/cloudant-gen2?topic=cloudant-gen2-database-partitioning).
