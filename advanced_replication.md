...
1.  Create a [replication document](/apidocs/cloudant#putreplicationdocument){: external} that describes the needed replication, and store the document in the [replicator database](/docs/cloudant-gen2?topic=cloudant-gen2-replication-api#the-replicator-database).
